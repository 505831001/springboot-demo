...
public class Oauth2ClientTest {
    ...
    public void getToken() throws Exception {
        ...
        int status = this.mockMvc.perform(post("/oauth/token")
                .header("Authorization", "Basic " + Base64.getEncoder().encodeToString("baidu:123456".getBytes()))
                .params(map)
