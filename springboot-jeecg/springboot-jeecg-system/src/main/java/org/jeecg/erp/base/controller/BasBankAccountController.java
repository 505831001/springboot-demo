...
import org.jeecg.erp.base.entity.BasBankAccount;
import org.jeecg.erp.base.service.IBasBankAccountService;
 ...
 */
@RestController
@RequestMapping(value = "/bas/basBankAccount")
@Api(value = "", tags = "银行账户处理控制器")
@Slf4j
