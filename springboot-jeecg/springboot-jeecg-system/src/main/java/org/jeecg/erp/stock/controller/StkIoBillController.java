...
import org.jeecg.erp.stock.service.IStkIoBillService;
import org.jeecg.erp.stock.vo.StkIoBillPage;
 ...
 */
@RestController
@RequestMapping(value = "/stock/stkIoBill")
@Api(value = "", tags = "出入库单处理控制器")
@Slf4j
public class StkIoBillController {
    ...
    @GetMapping(value = {"/list", "/list/{stockIoType}", "/list/{stockIoType}/{isRubric}"})  //stockIoType会传至stkIoBill.stockIoType
