...
import org.jeecg.erp.finance.service.IFinReceivableCheckService;
import org.jeecg.erp.finance.vo.FinReceivableCheckPage;
...
public class FinReceivableCheckController {
    ...
    @GetMapping(value = {"/list", "/list/{receivableCheckType}"})
    //receivableCheckType会传至finReceivableCheck.receivableCheckTypeCheckType
