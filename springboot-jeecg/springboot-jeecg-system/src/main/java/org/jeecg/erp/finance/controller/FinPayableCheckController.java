...
import org.jeecg.erp.finance.entity.FinPayableCheck;
...
import org.jeecg.erp.finance.service.IFinPayableCheckService;
import org.jeecg.erp.finance.vo.FinPayableCheckPage;
 ...
 */
@RestController
@RequestMapping(value = "/finance/finPayableCheck")
@Api(value = "", tags = "往来核销单处理控制器")
@Slf4j
