...
public class DemoShiroApplication {
     ...
     * private static final org.slf4j.Logger SLF4J = LoggerFactory.getLogger(DemoShiroApplication.class);
     * 异步日志-实现层：log4j<org.apache.log4j>
     * private static final Logger LOG4J2 = LogManager.getLogger(DemoShiroApplication.class);
     */
